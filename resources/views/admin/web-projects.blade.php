        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Web Projects</h1>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 border-b border-gray-200 dark:border-zinc-700">
            <nav class="flex space-x-8" aria-label="Tabs">
                ...
                <a href="{{ route('admin.web-projects') }}" class="border-blue-500 text-blue-500 px-1 py-4 text-sm font-medium border-b-2">
                    Projects 
        ...
        <div class="mb-8">
            <a href="{{ route('admin.web-projects.create') }}" class="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white px-6 py-3 rounded-xl font-medium transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/20 flex items-center gap-2">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">URL</th>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-zinc-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-zinc-700/50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="h-10 w-10 flex-shrink-0">
                                    <img class="h-10 w-10 rounded-lg object-cover" src="{{ $project->image_path ?: 'https://placehold.co/100x100' }}" alt="">
                                </div>
                                <div class="ml-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($project->url)
                                <a href="{{ $project->url }}" target="_blank" class="text-blue-500 underline">{{ Str::limit($project->url, 30) }}</a>
                            @else
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end space-x-3">
                                <a href="{{ route('admin.web-projects.edit', $project->id) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300">Edit</a>
                                <button type="button" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300 delete-btn" data-action="{{ route('admin.web-projects.destroy', $project->id) }}">Delete</button>
                            </div>
                        </td>
                    </tr>
                    @endforeach
